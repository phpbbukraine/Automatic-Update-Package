...
$lang = array_merge($lang, array(
	...
	<br />
	Ваша інформація збирається двома способами. По-перше, перегляд «%1$s» призведе до створення програмним забезпеченням phpBB певного числа cookies (невеликих текстових файлів, які завантажуються в папку тимчасових файлів вашого браузера). Перші дві cookie містять лише ідентифікатор користувача (надалі «user-id») і ідентифікатор анонімної сесії (надалі «session-id»), які автоматично присвоюються вам програмним забезпеченням phpBB. Третя cookie буде створено після перегляду однієї з тем конференції «%1$s» и будет использоваться для хранения информации о прочтённых вами темах, повышая таким образом удобство работы с форумами.<br />
	<br />
...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_ACTIVE_PROFILE'		=> 'Ваш обліковий запис успішно була повторно активованj.',
	...
	'ADD_FRIENDS'					=> 'Добавити новыи друзів',
	...
	'BOOKMARKS'					=> 'Закладки',
	'BOOKMARKS_EXPLAIN'			=> 'Ви можете додавати теми у закладки для майбутнього звернення. Встановіть прапорець для будь закладки, яку ви хочете видалити, потім натисніть кнопку <em>Удалить отмеченные закладки</em>.',
	...
	'EMAIL_INVALID_EMAIL'		=> 'Введена Адреса email є неправильною.',
	...
	'MESSAGE_REMOVED_FROM_OUTBOX'	=> 'Автор видалив це повідомлення до того, як ви встигли його прочитати.',
	'MESSAGE_SENT_ON'				=> 'від',
	...
	'NOTIFY_ON_PM'					=> 'Повідомляти мене про нових приватнихповідомленнях',
	...
	'POPUP_ON_PM'				=> 'Спливаюче вікно при отриманні особистого повідомлення',
