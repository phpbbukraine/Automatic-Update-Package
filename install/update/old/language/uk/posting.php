...
$lang = array_merge($lang, array(
	...
	'BBCODE_B_HELP'				=> 'Жирний текст: [b]text[/b]',
	'BBCODE_C_HELP'				=> 'Код: [code]code[/code]',
	'BBCODE_D_HELP'				=> 'Флеш: [flash=width,height]http://url[/flash]',
	'BBCODE_F_HELP'				=> 'Розмір шрифта: [size=85]small text[/size]',
	'BBCODE_IS_OFF'				=> '%sBBCode%s <em>ВИМКНЕНИЙ</em>',
	'BBCODE_IS_ON'				=> '%sBBCode%s <em>ВКЛЮЧЕНИЙ</em>',
	'BBCODE_I_HELP'				=> 'Похилий текст: [i]text[/i]',
	'BBCODE_L_HELP'				=> 'Список: [list]text[/list]',
	'BBCODE_LISTITEM_HELP'		=> 'Елемент списку: [*]text[/*]',
	'BBCODE_O_HELP'				=> 'Нумерований список: [list=]text[/list]',
	...
	'BBCODE_W_HELP'				=> 'Вставити посилання: [url]http://url[/url] або [url=http://url]URL text[/url]',
	...
	'PHP_SIZE_OVERRUN'			=> 'Завеликий розмір додаткового файлу.<br />Максимальний розмір закачуваного файлу: %1$d %2$s.<br />Майте на увазі, що ця величина визначена в php.ini и средствами форума невозможно изменить это значение в большую сторону.',
